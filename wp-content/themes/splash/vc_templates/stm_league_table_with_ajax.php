...
<div class="stm-league-wrap <?php echo esc_attr($css_class) ?>">
    <div class="stm-single-league-title_box clearfix">
        <h4 class="sp-table-caption"><?php echo firstWordBold($title); ?><a href="" class="stm-link-all stm-link-all-league normal-font"><?php echo esc_html__('Full table', 'splash'); ?></a></h4>
    </div>
