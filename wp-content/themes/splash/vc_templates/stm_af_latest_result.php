...
<div class="stm-one-event-wrapper">
    ...
    if ($atts["block_style"] == "football_style"){
                ...
                <?php while ($latest_results_query->have_posts()):
                    ...
                    if (count($teams) > 1):
                                    ...
                                    if ($k != 0) {
                                    	if (isset($val["position"])) {
											...
											if(!isset($topData[$term->name])) {
												if(count($topData) == 0)  $topData = buildTopPlayerArray($k, $val, $city_1[0]->name);
												else $topData += buildTopPlayerArray($k, $val, $city_1[0]->name);
											} else {
												if($term->name == "Wide receiver" && $topData[$term->name][0]['rec'] < $val['rec']) {
													$topData = buildTopPlayerArray($k, $val, $city_1[0]->name);
                                            ...
                                            /*$topData[$term->name][0]['city_code'] = strtoupper(getSTMShortCityCode($city_1[0]->name));
									...
									if ($k != 0) {
                                        if (isset($val["position"])) {
                                            ...
                                            if(!isset($topDataOpponent[$term->name])) {
												if(count($topDataOpponent) == 0)  $topDataOpponent = buildTopPlayerArray($k, $val, $city_2[0]->name);
												else $topDataOpponent += buildTopPlayerArray($k, $val, $city_2[0]->name);
											} else {
                                            	if($term->name == "Wide receiver" && $topDataOpponent[$term->name][0]['rec'] < $val['rec']) {
                                            		$topDataOpponent = buildTopPlayerArray($k, $val, $city_2[0]->name);
                        ...
                        <div class="stm-custom-row">
                            <div class="col-20">
                                <a href="<?php echo esc_url($team_1_url); ?>">
                                    <div class="stmLeftHelmsWrapp">
                                        ...
                                        if ($leftHelm == "") $leftHelm = esc_html(getLocalImgUrl("helms/" . $atts["left_helms"] . ".png"));
                                        ?>
                                        <img src="<?php echo $leftHelm; ?>"/>
                            ...
                            <div class="col-60">
                                <div class="stm-custom-row">
                                    <div class="<?php echo ($eventType == "publish") ? "col-35" : "col-40"; ?>">
                                        <div class="teamNameLeftWrapper heading-font">
                                            <span class="teamHome"><?php echo esc_html($city_1[0]->name) ?></span>
                                            <div class="stm-latest-result-team">
                                                <?php echo($team_1_full_link); ?>
                                                    ...
                                                    <?php if (!empty($team_results[0])): ?>
                                                        <?php if (!empty($team_results[0][$team_1_id])): ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="stm-latest-result-lose-label"><?php esc_html_e($team_results[0][$team_1_id]['outcome'][0], 'splash') ?></div>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                                                    ...
                                                    <?php if (!empty($team_results[0])): ?>
                                                        <?php if (!empty($team_results[0][$team_2_id])): ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="stm-latest-result-lose-label"><?php esc_html_e($team_results[0][$team_2_id]['outcome'][0], 'splash') ?></div>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                                    ...
                                    <?php if (is_layout("af")) : ?>
                                        <div class="col-md-4">
                                            <div class="stmTopWrapper">
                                                <span class="stmTopTitle heading-font"><?php echo esc_html_e('Top Passer', 'splash') ?></span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="stmTopWrapper">
                                                <span class="stmTopTitle heading-font"><?php echo esc_html_e('Top Rusher', 'splash') ?></span>
                                                <span class="stmFirstTopPlayer normal_font">
                                        ...
                                        <div class="col-md-4">
                                            <div class="stmTopWrapper">
                                                <span class="stmTopTitle heading-font"><?php echo esc_html_e('Top Receiver', 'splash') ?></span>
                                                <span class="stmFirstTopPlayer normal_font">
                                                ...
                                                if ($performance) {
                                                    ...
                                                    foreach ($performance[$team_id] as $player_id => $player) {
                                                        if (isset($player[$goals])) {
                                                            if ($player[$goals] >= 1) {
                                                                $output .= '<li>' . esc_html(get_the_title($player_id)) . ' - <span>' . esc_html($player[$goals]) . ' ' . __('goal(s)', 'splash') . '</span></li>';
                                                            }
                                                        }
                                                    }
                                                    $output .= '</ul>';
                            ...
                            <div class="col-20">
                                <a href="<?php echo esc_url($team_1_url); ?>">
                                    <div class="stmRightHelmsWrapp">
                                        ...
                                        if ($rightHelm == "") $rightHelm = esc_html(getLocalImgUrl("helms/" . $atts["right_helms"] . ".png"));
                                        ?>
                                        <img class="stm-helm" src="<?php echo $rightHelm; ?>"/>
        ...
        if (!empty($data)) {
            ...
            $output .= '<a class="button button-default" href="' . esc_url(get_the_permalink($id)) . '"><span>' . __('read more', 'splash') . '</span></a>';
            $output .= '</div>';
            $output .= '</div></div>';
        ...
        <div class="stm_bsb_latest_results_wrapper">
            <h2><?php echo esc_html($atts['title']); ?></h2>
            <h4><?php echo esc_html($sp_league[0]->name); ?></h4>
            <div class="stm-latest-results-units">
                <?php $prev_date = $prev_venue = ''; ?>
                <?php while ($latest_results_query->have_posts()):
                    $latest_results_query->the_post();
                    ...
                    if (count($teams) > 1):
                                ...
                                foreach ($players[0][$team_2_id] as $k => $val) {
                                    if ($k != 0) {
                                        if (isset($val["position"])) {
                                            ...
                                            $topData[$term->name][1]['city_code'] = strtoupper(getSTMShortCityCode($city_2[0]->name));
                        ...
                        <div class="stm-teams-info-wrap">
                            ...
                            <div class="stm-info">
                                ...
                                <div class="stm-custom-row">
                                    <div class="<?php echo ($eventType == "future") ? "col-40" : "col-35"?>">
                                        <div class="teamNameLeftWrapper heading-font">
                                            <span class="teamHome"><?php echo esc_html($city_1[0]->name) ?></span>
                                            <div class="stm-latest-result-team">
                                                <?php echo($team_1_full_link); ?>
                                    ...
                                    <div class="<?php echo ($eventType == "future") ? "col-20" : "col-30"?>">
                                        <div class="stmVSWrapp heading-font">
                                        <?php
                                            if($eventType == "future"):
