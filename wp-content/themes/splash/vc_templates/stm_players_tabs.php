...
<div class="stm-players-tabs" data-count="<?php echo esc_attr($count); ?>">
	...
	?>
		<div class="player-info-wrap <?php echo $i == 1 ? 'active' : ''; ?> player-slide-<?php echo $i; ?>" data-slide="<?php echo $i; ?>">
			<div class="player-image">
				<a href="<?php echo get_permalink($player_id); ?>">
					<?php echo $img['thumbnail']; ?>
				</a>
				<span class="player-number heading-font"><?php echo $player_number; ?></span>
			</div>
			...
			<div class="player-data">
				<div class="player-circle-section">
					<div class="player-circle-wrap">
						...
						<b><?php echo esc_html_e('Wins', 'splash'); ?></b>
					</div>
					<div class="player-circle-wrap">
						<div class="player-circle">
						...
						<b><?php echo esc_html_e('Appearances', 'splash'); ?></b><br>
					</div>
				</div>
	...
	<div class="player-carousel">
		...
		<div class="player-carousel__item">
			<a href="player-slide-<?php echo $q; ?>" class="<?php echo $q == 1 ? 'active' : ''; ?> player-slide-thumb-<?php echo $q; ?>" data-slide="<?php echo esc_attr($q); ?>">
				<?php echo $img['thumbnail']; ?>
