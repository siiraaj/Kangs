...
if($atts["table_style"] == "style_one") {
	...
	if ($title && $title != "" && $atts["table_style"] == "style_one") {
		$viewAll = (is_af()) ? esc_html__('See all results', 'splash') : esc_html__('View all', 'splash');
	...
	$output .= '<th class="data-rank normal_font">' . __( 'Pos', 'sportspress' ) . '</th>';
	...
	$output .= '<a class="sp-league-table-link sp-view-all-link heading-font" href="' . esc_url( get_permalink( $id ) )  . '">' . __( 'view all', 'splash' ) . '</a>';
