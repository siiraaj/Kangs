                        ...
                        if (!empty($image)): ?>
                            ...
                            <div class="stm-player-wrapp">
                                <div class="player_image">
                                    <a href="<?php echo esc_url(get_the_permalink($player_id)); ?>">
                                        <img src="<?php echo splash_get_thumbnail_url($player_id, 0, 'blog_list'); ?>" alt="<?php echo get_the_title($player_id) ;?>" />
                                    </a>
                                </div>
                                <div class="stm-player-title-wrap">
                                    <h4><a href="<?php echo esc_url(get_the_permalink($player_id)); ?>"><?php echo esc_attr(get_the_title($player_id)); ?></a></h4>
                                ...
                                <div class="player_info clearfix <?php if($player_number == "") echo "position-full-width"; ?>">
                                    <div class="number"><i class="icon-soccer_ico_tshirt"></i> <?php echo esc_attr($player_number); ?></div>
