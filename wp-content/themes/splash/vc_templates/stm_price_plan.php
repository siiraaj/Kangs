...
<div class="stm-price-plan-unit">
	<div class="stm-price-plan">
		...
		<header>
			<?php if(!empty($title)): ?>
				<div class="title <?php echo (is_layout("bb")) ? "h4" : "normal_font"; ?>">
			...
			<?php if(!empty($price_label)): ?>
				<div class="price-label <?php echo (!is_layout("af") && !is_layout("baseball")) ? "heading-font" : "normal_font"; ?>">
		...
		<?php if(!empty($feature)): ?>
			<div class="body <?php echo (!is_layout("af") && !is_layout("baseball")) ? "heading-font" : "normal_font"; ?>">
