...
if ($next_match_query->have_posts()): ?>
                                ...
                                <div class="stm-next-match-main-meta">
                                    ...
                                    <div class="stm-next-match-opponents-units">
                                        <div class="stm-next-match-opponents">
                                            <?php
                                            $size = (is_layout('magazine_one')) ? 'full' : 'stm-200-200';
                                            ...
                                            <div class="stm-command-vs"><span><?php esc_html_e('vs', 'splash'); ?></span>
                                            </div>
    ...
    elseif($atts["view_type"] == "blocks"):
        ...
        while ($next_match_query->have_posts()){
            ...
            $output .= '<time datetime="'.esc_attr( get_the_time('Y/m/d H:i:s') ) .'"  data-countdown="'.esc_attr( str_replace( "-", "/", get_the_time('Y/m/d H:i:s') ) ).'">';
	...
	elseif($atts["view_type"] == "single"):
		...
		$output .= '<p class="countdown sp-countdown long-countdown clear">';
			...
			$output .= '<time datetime="'.esc_attr( get_the_time('Y/m/d H:i:s') ) .'"  data-countdown="'.esc_attr( str_replace( "-", "/", get_the_time('Y/m/d H:i:s') ) ).'">';
			$output .= '<span class="heading-font">'.sprintf( '%02s', $days ).' <small class="normal-font">'.__( 'days', 'sportspress' ).'</small></span>';
			$output .= '<span class="heading-font">'.sprintf( '%02s', $h ).' <small class="normal-font">'.__( 'hrs', 'sportspress' ).'</small></span>';
			$output .= '<span class="heading-font">'.sprintf( '%02s', $i ).' <small class="normal-font">'.__( 'mins', 'sportspress' ).'</small></span>';
			$output .= '<span class="heading-font">'.sprintf( '%02s', $s ).' <small class="normal-font">'.__( 'secs', 'sportspress' ).'</small></span>';
			$output .= '</time>';
			$output .= '</p>';
