...
<div class="stm-trophy-carousel <?php echo esc_attr($id); ?>">
	...
	<div class="clearfix">
		<?php if(!empty($title) && !is_layout('soccer_two')): ?>
...
<script type="text/javascript">
	(function($) {
		...
		$(document).ready(function () {
			var slides = 4;
			<?php echo (is_layout("sccr")) ? 'slides = 5; ' : ''; ?>
			<?php echo (is_layout("soccer_two")) ? 'slides = 1; ' : ''; ?>
			<?php echo (is_layout("soccer_two")) ? 'itemQuant768 = 1; ' : ''; ?>
			owl.owlCarousel({
				items: slides,
				dots: false,
				autoplay: false,
				...
				responsive:{
					...
					415: {
                        items: <?php echo (is_layout("soccer_two")) ? 1 : 2; ?>,
                        slideBy: <?php echo (is_layout("soccer_two")) ? 1 : 2; ?>
					},
					768:{
						items:itemQuant768,
					...
					992:{
						items: <?php echo (is_layout("soccer_two")) ? 1 : 3; ?>,
						slideBy: <?php echo (is_layout("soccer_two")) ? 1 : 3; ?>
					},
					1100: {
						items: slides,
						slideBy: slides
