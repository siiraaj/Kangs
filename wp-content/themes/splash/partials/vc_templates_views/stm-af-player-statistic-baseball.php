                ...
                if($post_id != 0):
                    ...
                    if($player != null) :
                        ...
                        if(!empty($player_image_id)) {
                            $image = (is_layout("baseball")) ? splash_get_thumbnail_url( 0, $player_image_id, 'player_stat_ava' ) : splash_get_thumbnail_url( 0, $player_image_id, 'full' );
                        } else {
                            $image = '';
                        }
                                    ...
                                    <div class="stm-player-stat">
                                        <div class="stm-statistic-meta">
                                            ...
                                            <div class="stm-custom-row">
                                                ...
                                                <a href="<?php echo esc_url($player_url); ?>" class="button stm-mobile-hide only_border">
