	...
	<div class="customizer_wrapper">
		...
		<div class="customizer_element __demos">
			<select name="demos_switcher" id="demos_switcher" data-class="demos_switcher">
				<option class="demo_four" demo-url="http://splash.stylemixthemes.com/baseball/" value="http://splash.stylemixthemes.com/baseball/"><?php esc_html_e( 'Baseball', 'splash' ); ?></option>
				<option class="demo_one" demo-url="http://splash.stylemixthemes.com" value="http://splash.stylemixthemes.com/basketball"><?php esc_html_e( 'Basketball', 'splash' ); ?></option>
				<option class="demo_two" demo-url="http://splash.stylemixthemes.com/football/" value="http://splash.stylemixthemes.com/football/"><?php esc_html_e( 'Football', 'splash' ); ?></option>
				<option class="demo_three" demo-url="http://splash.stylemixthemes.com/soccer/" value="http://splash.stylemixthemes.com/soccer/"><?php esc_html_e( 'Soccer', 'splash' ); ?></option>
				<option class="demo_five" demo-url="http://splash.stylemixthemes.com/magazine-one/" value="http://splash.stylemixthemes.com/magazine-one/"><?php esc_html_e( 'Club News', 'splash' ); ?></option>
				<option class="demo_five" demo-url="http://splash.stylemixthemes.com/magazine-one/" value="http://splash.stylemixthemes.com/magazine-two/"><?php esc_html_e( 'Football Magazine', 'splash' ); ?></option>
				<option class="demo_five" demo-url="http://splash.stylemixthemes.com/magazine-one/" value="http://splash.stylemixthemes.com/soccer-two/"><?php esc_html_e( 'Soccer Two', 'splash' ); ?></option>
