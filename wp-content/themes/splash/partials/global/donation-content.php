	...
	<?php echo wp_kses_post($stm_sidebar_layout_mode['content_before']); ?>
		...
		<div class="clearfix">
			<div class="stm-donation-cash">
				...
				<div class="stm-donation-procent">
					<div class="stm-range-wrapp">
						...
						<div class="stm-range-control" <?php echo ($procent > 0) ? "style='left: " . $procent . ";'" : "style='left: 99.4%;'";?>></div>
					</div>
				</div>
				<?php endif; ?>
			</div>
			...
			<div class="stm-donate">
				<a href="#" data-toggle="modal" data-target="#donationModal" class="button with_bg <?php if(is_af()) echo "btn-md"; ?>"><?php esc_html_e('Donate now', 'splash'); ?></a>
			</div>
