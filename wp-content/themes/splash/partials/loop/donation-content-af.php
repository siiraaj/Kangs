			...
			<div class="stm-donation-meta">
				...
				<div class="stm-donation-procent">
					<div class="stm-range-wrapp">
						...
						<div class="stm-range-control" <?php echo ($procent > 0) ? "style='left: " . $procent . ";'" : "style='left: 99.1%;'";?>></div>
					</div>
				</div>
				<div class="content">
					<?php the_excerpt(); ?>
				</div>
				<a href="<?php the_permalink(); ?>" class="<?php echo (is_layout("baseball")) ? "normal_font" : "button"; ?>"><?php esc_html_e('More Info', 'splash') ?> <i class="fa fa-arrow-right" aria-hidden="true"></i> </a>
			</div>
