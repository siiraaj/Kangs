<div class="stm-latest-news-single">
    <div <?php post_class('stm-single-post-loop'); ?>>
        ...
        <div class="stm-news-data-wrapp">
            <div class="date <?php echo (!is_layout("af")) ? "heading-font" : "normal_font"; ?> clear">
            ...
            <div class="post-meta <?php echo (is_layout("bb")) ? "heading-font" : "normal_font"; ?> clear">
                <div class="news-category">
                    <i class="fa fa-folder-o" aria-hidden="true"></i>
                    <?php $categ = get_the_category(get_the_ID()); echo $categ[0]->cat_name; ?>
                </div>
