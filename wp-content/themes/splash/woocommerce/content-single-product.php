...
?>
	...
	<div class="row">
		...
		elseif(is_layout("sccr") || is_layout('soccer_two')) { $class_left = "col-md-4 col-sm-6"; $class_right = "col-md-8 col-sm-6"; }
		...
		<div class="<?php echo $class_right ; ?>">
			<div class="summary entry-summary stm-single-product-content-right <?php if(is_layout("bb")) echo "stm-bb-prod-cont-right"?>">
				...
				if((is_layout("sccr") && !wp_is_mobile()) || (is_layout('soccer_two') && !wp_is_mobile())) {
	...
	<?php
		 ...
		 */
		if(is_layout("sccr") || is_layout('soccer_two')) {
			if(!wp_is_mobile()) {
