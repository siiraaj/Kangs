	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6">
			<div class="stm-cart-totals">
				<<?php echo (is_layout("baseball")) ? "h3" : "h4"; ?>><?php esc_html_e( 'Cart Totals', 'splash' ); ?></<?php echo (is_layout("baseball")) ? "h3" : "h4"; ?>>
			...
			<div class="col-md-6 col-sm-6">
				<div class="stm-shipping-cart-calc">
					...
					<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
						...
						<div class="shipping">
							<<?php echo (is_layout("baseball")) ? "h3" : "h4"; ?>><?php esc_html_e( 'Shipping', 'splash' ); ?></<?php echo (is_layout("baseball")) ? "h3" : "h4"; ?>>
