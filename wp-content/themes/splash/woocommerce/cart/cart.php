...
<table class="shop_table shop_table_responsive cart heading-font woocommerce-cart-form__contents" cellspacing="0">
	<thead>
		<tr>
			...
			<?php endif; ?>
			<th class="product-thumbnail"><?php if(!is_layout("sccr")) esc_html_e( 'Product', 'splash' ); ?></th>
			<th class="product-name"><?php (!is_layout("sccr")) ? esc_html_e( 'Name', 'splash' ) : esc_html_e( 'Product', 'splash' ); ?></th>
