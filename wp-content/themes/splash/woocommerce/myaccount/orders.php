...
<?php if ( $has_orders ) : ?>
<?php if(is_af()): ?><div class="sp-scrollable-table-wrapper"><?php endif; ?>
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table <?php if(!is_af()) echo "shop_table_responsive"; ?> my_account_orders account-orders-table">
		<thead>
			<tr>
