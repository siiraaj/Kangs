	            ...
	            <div class="stm-next-match-main-meta">
					...
					<div class="stm-next-match-opponents-units">
						<div class="stm-next-match-opponents <?php if(empty($team_results[0][$team_1_id][$point_system]) and empty($team_results[0][$team_2_id][$point_system])) echo "stm_event_future "; ?>">
							...
							$imgSize = (is_layout("baseball")) ? 'full' : 'stm-200-200';
								...
								<?php if(!empty($team_2_image)): ?>
									<div class="stm-command-logo">
										<a href="<?php echo esc_url($team_2_url); ?>">
											...
											?>
											<img src="<?php echo esc_url($attachImg[0]); ?>" /><?php endif; ?>
					...
					<?php if(is_layout("af") || is_layout("baseball")) echo "<div class='stm-next-match-info-wrapp'>"; ?>
					
					<div class="stm-next-match-info  <?php echo (is_layout("bb")) ? "heading-font" : "normal-font"?>">
						<?php echo esc_attr(implode(',', $leagues_names) . ' ' . $date_show); ?>
					</div>
	
					<?php if(!empty($venue_name)): ?>
						<div class="stm-next-match-venue  <?php echo (is_layout("bb")) ? "heading-font" : "normal-font"?>">
							<?php echo esc_attr($venue_name); ?>
						</div>
					<?php endif; ?>
					
					<?php if(is_layout("af") || is_layout("baseball")) echo "</div>"; ?>
				</div>
