<?php
class STM_Widget_Event_List extends WP_Widget {
	
	function __construct() {
		$widget_ops = array('classname' => 'widget_sportspress widget_stm_event_list', 'description' => __( 'A list of events.', 'splash' ) );
		parent::__construct('stm-sportspress-event-list', __( 'STM SP Event List', 'splash' ), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		sp_get_template( 'widget-event-list.php', array( 'id' => $id, 'title' => $caption, 'status' => $status, 'date' => $date, 'date_from' => $date_from, 'date_to' => $date_to, 'day' => $day, 'number' => $number, 'columns' => $columns, 'order' => $order, 'show_all_events_link' => $show_all_events_link , 'is_widget' => true) );
...
function register_event_list_widget() {
	register_widget( 'STM_Widget_Event_List' );
}

//add_action( 'widgets_init', 'register_event_list_widget' );