...
function splash_enqueue_scripts_styles() {
	...
	if($skin == 'default' or $skin == 'site_style_custom') {
		if ( is_dir( $upload_dir['basedir'] . '/stm_uploads' ) and $skin != 'default' ) {
            ...
            if(is_layout("af")) wp_enqueue_style('stm-theme-style-af', $template_path . '/assets/css/american_football_styles.css', null, STM_THEME_VERSION, 'all');
            else if(is_layout("sccr")) wp_enqueue_style('stm-theme-style-sccr', $template_path . '/assets/css/soccer_styles.css', null, STM_THEME_VERSION, 'all');
            else if(is_layout("baseball")) wp_enqueue_style('stm-theme-style-baseball', $template_path . '/assets/css/baseball_styles.css', null, STM_THEME_VERSION, 'all');
            else if(is_layout("magazine_one")) wp_enqueue_style('stm-theme-style-magazine-one', $template_path . '/assets/css/magazine_one_styles.css', null, STM_THEME_VERSION, 'all');
            else if(is_layout("magazine_two")) wp_enqueue_style('stm-theme-style-magazine-two', $template_path . '/assets/css/magazine_two_styles.css', null, STM_THEME_VERSION, 'all');
            else if(is_layout("soccer_two")) wp_enqueue_style('stm-theme-style-soccer-two', $template_path . '/assets/css/soccer_two_styles.css', null, STM_THEME_VERSION, 'all');
        }
	} else {
	...
	if(is_singular('product') && !is_layout("sccr")) {
