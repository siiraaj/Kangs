				...
				<div class="stm-admin-one-half">
					<div class="stm-admin-one-half-inner">
						<h3>
							...
							<?php _e('Ticket System', 'splash'); ?>
						</h3>
						<p>
							<?php _e('We offer excellent support through our advanced ticket system. Make sure to register your purchase first to access our support services and other resources.', 'splash'); ?>
						</p>
				...
				<div class="stm-admin-one-half">
					<div class="stm-admin-one-half-inner">
						<h3>
							...
							<?php _e('Documentation', 'splash'); ?>
						</h3>
						<p>
							<?php printf(__('Our online documentaiton is a useful resource for learning the every aspect and features of %s.', 'splash'), $theme_name); ?>
						</p>
				...
				<div class="stm-admin-one-half">
					<div class="stm-admin-one-half-inner">
						<h3>
							...
							<?php _e('Video Tutorials', 'splash'); ?>
						</h3>
						<p>
							<?php printf(__('We recommend you to watch video tutorials before you start the theme customization. Our video tutorials can teach you the different aspects of using %s.', 'splash'), $theme_name); ?>
						</p>
				...
				<div class="stm-admin-one-half">
					<div class="stm-admin-one-half-inner">
						<h3>
							...
							<?php _e('Community Forum', 'splash'); ?>
						</h3>
						<p>
							<?php printf(__('Our forum is the best place for user to user interactions. Ask another %s user or share your experience with the community to help others.', 'splash'), $theme_name); ?>
						</p>
